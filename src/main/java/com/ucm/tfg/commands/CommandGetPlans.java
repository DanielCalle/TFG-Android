...
public class CommandGetPlans implements Command{
    ...
    public String execute(Object... objects) {
       String plan = "{\"id\":1,\"user\":\"" +
               ...
               "\"date\":\"2019-12-03\"," +
               "\"joinedUsers\":[{\"uuid\":\"1\",\"name\":\"Pepe\",\"email\":\"pepe@gmail.com\",\"password\":\"1234\",\"imageURL\":null}," +
               "{\"uuid\":\"2\",\"name\":\"Juan\",\"email\":\"juan@gmail.com\",\"password\":\"1234\",\"imageURL\":null}," +
               "{\"uuid\":\"a\",\"name\":\"a\",\"email\":\"a\",\"password\":\"a\",\"imageURL\":null}]}";
       return plan;
    }
